  ...
  return (
    <div className="min-h-screen grid grid-cols-[1.05fr_1fr] bg-auth-bg">
      <div className="relative overflow-hidden flex flex-col justify-between px-[60px] py-[56px] text-white bg-[linear-gradient(155deg,#F6A98E_0%,#F2937A_45%,#EC7E62_100%)]">
        <div aria-hidden="true" className="absolute w-[420px] h-[420px] rounded-full bg-[rgba(255,255,255,0.12)] -top-[140px] -right-[120px]" />
        <div aria-hidden="true" className="absolute w-[300px] h-[300px] rounded-full bg-[rgba(255,255,255,0.10)] -bottom-[110px] -left-[80px]" />

        <div className="relative flex items-center gap-[13px]">
          <span className="w-[46px] h-[46px] rounded-[14px] bg-[rgba(255,255,255,0.22)] flex items-center justify-center" aria-hidden="true">
            <SunMark size={26} />
          </span>
      ...
      <div className="flex items-center justify-center p-10">
        <div className="w-full max-w-[392px]">
          ...
          <form action={onSubmit}>
            <label htmlFor="email" className="block text-[12px] font-bold tracking-[0.7px] text-ink-muted mb-[8px]">
              EMAIL
            </label>
            <input
              id="email"
            ...
            <label htmlFor="password" className="block text-[12px] font-bold tracking-[0.7px] text-ink-muted mb-[8px]">
              CONTRASEÑA
            </label>
            <input
              id="password"
            ...
            {error && (
              <p role="alert" className="text-primary-dark text-[13.5px] mt-[10px]">{error}</p>
            )}
          </form>
